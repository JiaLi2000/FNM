...
class FairWalk:
    ...
    def __init__(self, graph: nx.Graph, dimensions: int = 128, walk_length: int = 80, num_walks: int = 10, p: float = 1,
                 ...
                 quiet: bool = False, temp_folder: str = None, seed: int = 0):
        """
    ...
    def _precompute_probabilities(self):
        ...
        nodes_generator = nodes_sorted if self.quiet \
            else tqdm(nodes_sorted, desc='Computing transition probabilities')
    ...
    def fit(self, **skip_gram_params) -> gensim.models.Word2Vec:
        ...
        if 'vector_size' not in skip_gram_params:
            skip_gram_params['vector_size'] = self.dimensions  # size -> vector_size
...
def parallel_generate_walks(d_graph: dict, global_walk_length: int, num_walks: int, cpu_num: int,
                            ...
                            first_travel_key: str = None, quiet: bool = False, seed: int = 0) -> list:
    """
    Generates the random walks which will be used as the skip-gram input.
